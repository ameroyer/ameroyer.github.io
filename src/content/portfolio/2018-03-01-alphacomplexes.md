...
twitter_summary: "A Python implementation of Delaunay triangulation and Alpha Complexes for 2D mesh generation."
---
...
<div class="img-row">
<img src="/notebooks/2016_08_01_AlphaComplexes/convexhull1.png" style="max-width:30%">
<img src="/notebooks/2016_08_01_AlphaComplexes/convexhull.png" style="max-width:30%">
<img src="/notebooks/2016_08_01_AlphaComplexes/convexhull2.png" style="max-width:30%">
</div>
...
\begin{align}
DL(S): x \leftrightarrow x' \iff V*x \mbox{ adjacent to } V*{x'}
\end{align}
...
\begin{align}
Vor*r(S) = \left[ V_x \cap B*{r}(x),\ \forall x \in S \right]
\end{align}
