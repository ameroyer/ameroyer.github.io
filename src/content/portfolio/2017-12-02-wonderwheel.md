...
twitter_summary: "A data visualization project for representing image color distributions as animated hue histograms."
---
...
<div style="display:flex; gap:20px; justify-content:center; align-items:flex-start; margin:20px 0; overflow-x:auto;">
<div style="width:444px; height:444px; position:relative; top:10px; left:0px; flex-shrink:0;">
<img style="border-radius: 50%; border: 0; top: 122px; left:122px; height: 200px; width:200px; position:absolute; margin:0;" src="/notebooks/2017_12_02_wonderwheel/images/image2.jpeg">
...
<div style="width:444px; height:444px; margin-bottom:25px; top:10px; position:relative; flex-shrink:0;">
    <img style="border-radius: 50%; border: 0; top: 122px; left:122px; height: 200px; width:200px; position:absolute; margin:0;" src="/notebooks/2017_12_02_wonderwheel/images/image3.jpeg">
...
The remaining pixels will be used to compute the hue histograms. Each hue is additionally weighted by its _saturation_, so that low saturation colors, i.e. gray. get smaller weights, and an _originality factor_, which is defined as how far the color is from the average hue in the image.
